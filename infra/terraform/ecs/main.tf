  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
			  ...
			  { name = "SYMBOL",         value = "GBPUSD" },
				{ name = "DB_URL", value = "postgresql+psycopg://app:TempDb2026Abc123@gbpusd-signal-db.cpiwo4s0ilo0.ap-southeast-2.rds.amazonaws.com:5432/postgres?sslmode=require" }
			]
