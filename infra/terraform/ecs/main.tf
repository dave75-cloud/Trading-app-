  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "DB_URL",         value = "postgresql+psycopg://postgres:Ne1410is1975@gbpusd-signal-db.cpiwo4s0ilo0.ap-southeast-2.rds.amazonaws.com:5432/postgres?sslmode=require" }
      ]
